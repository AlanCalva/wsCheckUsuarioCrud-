        ...
        private async Task cargaDatosTipoUsuario()
        {
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    string apiUrl = "https://localhost:44304/check/usuario/vwTipoUsuario";
        ...
        private async Task cargaDatos()
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    string apiUrl = "https://localhost:44304/check/usuario/spinusuario";
                    // ----------------------------------------------
        ...
        private async Task buscarUsuario()
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    string apiUrl = "https://localhost:44304/check/usuario/spbususuario?clave=" + clave;
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    HttpContent contenido = new StringContent
                                (data, Encoding.UTF8, "application/json");
                    // Ejecución de la petición HTTP
                    string apiUrl = "https://localhost:44304/check/usuario/spupdusuario";
                    // ----------------------------------------------
                    HttpResponseMessage respuesta =
                        await client.PostAsync(apiUrl, contenido);
                    // ---------------------------------------------------
            ...
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    HttpContent contenido = new StringContent
                                (data, Encoding.UTF8, "application/json");
                    // Ejecución de la petición HTTP
                    string apiUrl = "https://localhost:44304/check/usuario/spdelusuario";
                    // ----------------------------------------------
                    HttpResponseMessage respuesta =
                        await client.PostAsync(apiUrl, contenido);
                    // ---------------------------------------------------
